package app.shoppingproject_kotlin.bucket
...
class BucketFragment : Fragment() {
    ...
    lateinit var binding : BucketFragmentBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.bucket_fragment, container, false)
        return binding.root
    }
